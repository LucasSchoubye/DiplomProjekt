...
// "game over"
draw_text_transformed(_camX + _camW/2, _camY + _camH/2 + _gameOverOffset , LC.translate("GAME OVER"), 4, 4, 0)

// "press R to restart or Q to Quit
var _messageOffset = 80
draw_text_transformed(_camX + _camW/2, _camY + _camH/2 + _messageOffset, LC.translate("- Press 'R' to restart or 'Q' to quit -"), 1, 1, 0)
